  ...
  const stages = [
    {
      ...
      content: (
        <ul className="ij-list">
          <li>
            Bi-weekly expert webinars that span technology, policy, and use-case
            design (in English/French)
          </li>
    ...
    },
    {
      ...
      content: (
        <ul className="ij-list">
          <li>
            24 shortlisted teams will receive dedicated use-case mentors
            (non-technical) and technical mentors (from MOSIP and technology
            partners).
          </li>
          <li>
            Weekly mentor-led prototyping sessions with regular check-ins
            (access to the MOSIP Innovation Sandbox will be provided).
          </li>
          <li>
            Mid-cycle presentations and pre-judging reviews will ensure teams
            are on track and their ideas are technically feasible.
          </li>
          <li>
            Regional semi-finals will be hosted at partner institutions across
            Africa.
          </li>
          <li>
            Community support will be available through Discord and WhatsApp
            platforms.
          </li>
        </ul>
      ),
    },
    {
      ...
      content: (
        <ul className="ij-list">
          <li>
            The semi-finals will be conducted at four different locations.
            Details of this will be announced soon.
          </li>
          <li>
            The semi-finals will include live demonstrations of prototypes and
            presentations.
          </li>
          <li>
            The top two teams per region will advance to the continental finals
            at ID4Africa 2026.
          </li>
        </ul>
      ),
    },
    {
      ...
      content: (
        <ul className="ij-list">
          <li>
            Day 1: Panel discussions and short presentations by finalist
            students
          </li>
