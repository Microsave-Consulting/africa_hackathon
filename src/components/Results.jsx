...
const semiImages = [
  { src: `${basePath}/semi_results/southern.jpg`, label: "Southern Africa" },
  { src: `${basePath}/semi_results/western.jpg`, label: "Western Africa" },
  {
    src: `${basePath}/semi_results/northern_and_central.jpg`,
    label: "Northern & Central Africa",
  },
  { src: `${basePath}/semi_results/eastern.jpg`, label: "Eastern Africa" },
];
