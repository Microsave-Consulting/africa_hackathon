              ...
              <div className="reg-social-list">
                ...
                <div className="reg-social-row">
                  ...
                  <p className="reg-social-text">
                    ...
                    <br />
                    <a
                      href="https://www.linkedin.com/company/upanzinetwork/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                ...
                <div className="reg-social-row">
                  ...
                  <p className="reg-hashtags">
                    <a
                      href="https://www.linkedin.com/search/results/all/?keywords=%23africadigitalidhackathon&origin=HASH_TAG_FROM_FEED"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <a
                      href="https://www.linkedin.com/search/results/all/?keywords=%23digitalid&origin=HASH_TAG_FROM_FEED"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      #DigitalID
                    ...
                    <a
                      href="https://www.linkedin.com/search/results/all/?keywords=%23id4africa&origin=HASH_TAG_FROM_FEED"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      #ID4Africa
                    ...
                    <a
                      href="https://www.linkedin.com/search/results/all/?keywords=%23digitalidentity&origin=HASH_TAG_FROM_FEED"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      #DigitalIdentity
