          ...
          <div className="ben-grid-all">
            ...
            <div className="ben-card">
              ...
              <div className="ben-card-text">
                ...
                <p className="ben-card-desc">
                  Receive guidance from use-case mentors (non-technical) and
                  technical mentors (from MOSIP and technology partners)
                </p>
              </div>
            </div>
            ...
            <div className="ben-card">
              ...
              <div className="ben-card-text">
                ...
                <p className="ben-card-desc">
                  Connect with Africa's digital ecosystem and potential future
            ...
            <div className="ben-card ben-card-4">
              ...
              <div className="ben-card-text">
                ...
                <p className="ben-card-desc">
                  Certificate of achievement, Internship opportunities with
                  Upanzi Network
                </p>
              </div>
            </div>
            ...
            <div className="ben-banner-rows">
              <div className="ben-banner-row">
                ...
                <p className="ben-banner-text">
                  All-expenses-paid trip to ID4Africa 2026 in Abidjan, Côte
                  d'Ivoire
                </p>
              </div>
              <div className="ben-banner-row">
                <div className="ben-dot"></div>
                <p className="ben-banner-text">
                  Support from CMU Africa Innovation Lab business incubation
                  program
                </p>
              </div>
            </div>
